...
| | |
|---|---|
| **API name** | `Osibtys Profile` |
| **Label** | `Osibtys Profile` |
...
Engagement-named profile of unclear purpose — name suggests an account-specific identifier. _(verify with engagement)_
...
_No notable system permission overrides._
