---
title: "Sales Insights Integration User"
audience: public
...
| | |
|---|---|
| **API name** | `Sales Insights Integration User` |
| **Label** | `Sales Insights Integration User` |
| **User license** | Sales Insights Integration User |
...
Stock Sales Insights integration user — service account. _(stock Salesforce)_
