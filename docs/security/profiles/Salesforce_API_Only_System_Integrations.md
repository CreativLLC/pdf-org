---
title: "Salesforce API Only System Integrations"
audience: public
...
| | |
|---|---|
| **API name** | `Salesforce API Only System Integrations` |
| **Label** | `Salesforce API Only System Integrations` |
| **User license** | Salesforce Integration |
| **License count** | _Not visible from source._ |
| **Origin** | Custom (engagement-authored) |
| **Description** | _Not set._ |

## Persona

Stock API-only integration profile — service account that cannot log in via UI. _(stock Salesforce)_
