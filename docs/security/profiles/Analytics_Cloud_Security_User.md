---
title: "Analytics Cloud Security User"
audience: public
...
| | |
|---|---|
| **API name** | `Analytics Cloud Security User` |
| **Label** | `Analytics Cloud Security User` |
...
Stock CRM Analytics security user — sharing-resolution service account. _(stock Salesforce)_
